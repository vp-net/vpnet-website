...
export default function ParticlesDemo() { 
   ...
   return (
      <div className="bg-black relative flex h-screen w-full flex-col sm:place-items-center items-center justify-center overflow-hidden">
         <span className="relative pointer-events-none text-7xl md:text-8xl lg:text-9xl whitespace-pre-wrap bg-gradient-to-b from-black to-gray-300/80 bg-clip-text text-center  sm:text-2xl font-semibold leading-none text-transparent dark:from-white dark:to-slate-900/10 sm:p-4">
            VPNET
