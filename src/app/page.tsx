...
export default function Home() {
  return (
    <main className="bg-[#000000] flex min-h-screen flex-col items-center pt-20  ps-5 lg:px-24 sm:ps-2 pe-3 px-24 sm:p-3">
     ...
     {/* <App/> */}
     <GlobeDemo/>
     <h1 className="relative z-1  text-2xl md:text-2xl lg:text-3xl  bg-clip-text text-transparent bg-gradient-to-b from-neutral-200 to-neutral-600  text-center font-sans font-bold">Features</h1>
     <FeaturesSectionDemo/>
